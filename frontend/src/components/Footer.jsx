...
const Footer = React.forwardRef((props,ref) => {
  return (
    <footer ref={ref} className="bg-gray-50 border-t border-gray-200">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-600">hello@premiumtoys.in</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 text-pink-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-gray-100">
        <div className="container mx-auto px-4 py-6 text-center text-gray-600">
          <p>
            © {new Date().getFullYear()} Premium Toys & Cute Stationery. 
            All rights reserved.
